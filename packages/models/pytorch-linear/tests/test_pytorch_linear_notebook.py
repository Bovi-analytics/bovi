...
NOTEBOOK = (
    Path(__file__).parents[1] / "notebooks/experiments/pytorch_linear/pytorch_linear_training.ipynb"
)


def test_pytorch_linear_tutorial_runs_end_to_end(tmp_path, monkeypatch):
    ...
    manifests = [
        ...
        for path in tmp_path.glob("bovi-pytorch-linear/*/*/training-results/*.json")
    ]
