...
NOTEBOOK = Path(__file__).parents[1] / "notebooks/experiments/scikit_sgd/scikit_sgd_training.ipynb"


def test_scikit_sgd_tutorial_runs_end_to_end(tmp_path, monkeypatch):
    ...
    manifests = [
        ...
        for path in tmp_path.glob("bovi-scikit-sgd/*/*/training-results/*.json")
    ]
